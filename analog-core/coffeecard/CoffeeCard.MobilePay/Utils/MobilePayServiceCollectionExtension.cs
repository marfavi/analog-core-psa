...
namespace CoffeeCard.MobilePay.Utils
{
    ...
    public static class MobilePayServiceCollectionExtension
    {
        ...
        )
        {
            ...
            services
                .AddHttpClient<IEPaymentClient, EPaymentClientMock>(client =>
                {
            ...
            services
                .AddHttpClient<IWebhooksClient, WebhooksClientMock>(client =>
                {
                    client.AddDefaultHeaders(mobilePaySettings);
                    client.BaseAddress = mobilePaySettings.ApiUrl;
                })
            ...
            services.AddHttpClient<IAccessTokenClient, AccessTokenClientMock>(client =>
            {
                client.AddDefaultHeaders(mobilePaySettings);
                client.BaseAddress = mobilePaySettings.ApiUrl;
            });
