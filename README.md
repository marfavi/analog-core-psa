...
Exam project for Practical Software Analysis 2025

Authors: Lukas Lykkeskov Hjelmstrand, Michael Jeppesen, Omid Sabihi Marfavi

Read the report: [report.pdf](./report.pdf)

Code coverage reports: https://marfavi.github.io/analog-core-psa/

Analog Core can be found at https://github.com/AnalogIO/analog-core
...
dotnet run
```
now open [the Jupyter notebook](./fuzz/_swagger_fuzzer.ipynb) in vscode and run the cells (if needed select global python kernel), the fuzzer is running!
